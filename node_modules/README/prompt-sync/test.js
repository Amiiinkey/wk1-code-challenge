//basic:
console.log(require('README/prompt-sync')()('tell me something about yourself: '))

// ANSI escape codes colored text test
require('README/prompt-sync')()('\u001B[31mcolored text: \u001B[39m');

var prompt = require('README/prompt-sync')({
